...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/main/box_group.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Jan 2021 11:12:34 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>EduAdmin - Dashboard  Group Box </title>
			  ...
			  <div class="col-12">			
				<div class="card">
				  <div class="card-header">
					<h4 class="card-title">Deck
						<p class="subtitle font-size-14 mb-0">Need a set of equal width and height cards that aren’t attached to one another? Use box decks.</p>
					</h4>
				  </div>
				</div>
			  </div>	
				...
				<div class="card">
				  <div class="card-header">
					<h4 class="card-title">Group
						<p class="subtitle font-size-14 mb-0">Use card groups to render cards as a single, attached element with equal width and height columns.</p>
					</h4>
				  </div>
				</div>
			  </div>
				...
				<div class="card">
				  <div class="card-header">
					<h4 class="card-title">Columns
						<p class="subtitle font-size-14 mb-0">ards can be organized into Masonry-like columns with just CSS by wrapping them in <code>.card-columns</code>. cards are ordered from top to bottom and left to right when wrapped in <code>.card-columns</code>.</p>
					</h4>
				  </div>
				</div>
			  </div>	
...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/main/box_group.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Jan 2021 11:12:43 GMT -->
</html>
