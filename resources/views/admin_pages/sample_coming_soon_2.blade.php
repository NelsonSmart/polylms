...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/main/sample_coming_soon_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Jan 2021 11:17:37 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>EduAdmin - Coming soon 2 </title>
					...
					<div class="box-body text-center">	
					  ...
					  <!--//timer-->
					   <div class="flexbox justify-content-center">
							<button type="button" class="btn btn-danger btn-md mb-5" data-toggle="modal" data-target="#modal-center"><i class="mdi mdi-send"></i> Notify Me </button>
