...
<!-- Mirrored from www.multipurposethemes.com/admin/eduadmin-template/main/component_modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Jan 2021 11:15:14 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>EduAdmin - Dashboard  Modals UI </title>
  ...
  <div class="modal modal-danger fade" id="modal-danger">
	  <div class="modal-dialog">
		<div class="modal-content bg-danger">
		  ...
		  <div class="modal-footer">
			<button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
			<button type="button" class="btn btn-info float-right">Save changes</button>
		  </div>
		</div>
		<!-- /.modal-content -->
	  </div>
